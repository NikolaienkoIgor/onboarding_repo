...
|---------|-------------------|
| **Chapter 1 – Toolstack** | The software, platforms and services we use every day |
...
- [ ] Laptop with standard software installed

!!! info "Need help?"
    Reach out in the **#onboarding** Slack channel. Someone on the team is always happy to help.
